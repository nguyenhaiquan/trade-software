...
namespace DataAccess.ServiceReference1 {
    ...
    public interface IStockService {
        ...
        commonClass.TradePointInfo[] GetTradePointWithEstimationDetail(out databases.tmpDS.tradeEstimateDataTable toTbl, out application.StrategyStatistics statistics, commonClass.DataParams dataParam, string stockCode, string strategyCode, commonClass.EstimateOptions options);
    ...
    public partial class StockServiceClient : System.ServiceModel.ClientBase<DataAccess.ServiceReference1.IStockService>, DataAccess.ServiceReference1.IStockService {
        ...
        public commonClass.TradePointInfo[] GetTradePointWithEstimationDetail(out databases.tmpDS.tradeEstimateDataTable toTbl, out application.StrategyStatistics statistics, commonClass.DataParams dataParam, string stockCode, string strategyCode, commonClass.EstimateOptions options) {
