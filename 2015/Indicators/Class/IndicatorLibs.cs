...
namespace Indicators
{
    ...
    public class Libs
    {
        ...
        public static void GetLocalConfig(Meta meta)
        {
            ...
            aFields.Add("output");
            aFields.Add("drawInNewWindow");
            if (!application.Configuration.GetLocalUserConfig(meta.ClassType.FullName, aFields)) return;
        ...
        public static bool SaveLocalConfig(Meta meta)
        {
            ...
            if (!application.Configuration.SaveLocalUserConfig(meta.ClassType.FullName, aFields, aValues)) return false;
            return true;
        }
    }
}
