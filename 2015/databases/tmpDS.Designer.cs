...
namespace databases {
    ...
    public partial class tmpDS : global::System.Data.DataSet {
        ...
        private global::System.Data.DataRelation relationFK_investorStock_stockCode;
        ...
        internal void InitVars(bool initTable) {
            ...
            this.relationFK_investorStock_stockCode = this.Relations["FK_investorStock_stockCode"];
        }
        ...
        private void InitClass() {
            ...
            this.relationFK_investorStock_stockCode = new global::System.Data.DataRelation("FK_investorStock_stockCode", new global::System.Data.DataColumn[] {
                        this.tablestockCode.codeColumn}, new global::System.Data.DataColumn[] {
                        this.tableinvestorStock.stockCodeColumn}, false);
            this.Relations.Add(this.relationFK_investorStock_stockCode);
        }
        ...
        public partial class stockCodeDataTable : global::System.Data.TypedTableBase<stockCodeRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public stockCodeRow AddstockCodeRow(string code, string stockExchange, string tickerCode, string name, string nameEn, int selected, decimal price, decimal priceVariant, decimal volume) {
        ...
        public partial class investorStockDataTable : global::System.Data.TypedTableBase<investorStockRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public investorStockRow AddinvestorStockRow(stockCodeRow parentstockCodeRowByFK_investorStock_stockCode, string portfolio, decimal qty, decimal buyAmt) {
                ...
                object[] columnValuesArray = new object[] {
                        ...
                        qty,
                        buyAmt};
                if ((parentstockCodeRowByFK_investorStock_stockCode != null)) {
                    columnValuesArray[0] = parentstockCodeRowByFK_investorStock_stockCode[0];
                }
        ...
        public partial class stockCodeRow : global::System.Data.DataRow {
            ...
            public decimal volume {
                get {
                    try {
                        return ((decimal)(this[this.tablestockCode.volumeColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public investorStockRow[] GetinvestorStockRows() {
                if ((this.Table.ChildRelations["FK_investorStock_stockCode"] == null)) {
                    return new investorStockRow[0];
                }
                else {
                    return ((investorStockRow[])(base.GetChildRows(this.Table.ChildRelations["FK_investorStock_stockCode"])));
                }
            }
        }
        ...
        public partial class investorStockRow : global::System.Data.DataRow {
            ...
            public stockCodeRow stockCodeRow {
                get {
                    return ((stockCodeRow)(this.GetParentRow(this.Table.ParentRelations["FK_investorStock_stockCode"])));
                }
                set {
                    this.SetParentRow(value, this.Table.ParentRelations["FK_investorStock_stockCode"]);
                }
            }
...
SELECT code, stockExchange, tickerCode, name, nameEn, 0 AS selected FROM stockCode WHERE (code = @code)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT code, stockExchange, tickerCode, name, nameEn, 0 AS selected FROM stockCod" +
                "e WHERE (code = @code)";
            ...
            this._commandCollection[1].CommandText = "SELECT code, name, nameEn, 0 AS selected, stockExchange, tickerCode FROM stockCod" +
                "e WHERE (bizSectors LIKE @bizSectors) AND (status & @status > 0) ORDER BY code";
            ...
            this._commandCollection[2].CommandText = "SELECT code, name, nameEn, 0 AS selected, stockExchange, tickerCode FROM stockCod" +
                "e WHERE (status & @statusMask > 0) ORDER BY code";
            ...
            this._commandCollection[3].CommandText = "SELECT code, name, nameEn, 0 AS selected, stockExchange, tickerCode FROM stockCod" +
                "e WHERE (stockExchange = @stockExchange) AND (status & @statusMask > 0) ORDER BY" +
                " code";
