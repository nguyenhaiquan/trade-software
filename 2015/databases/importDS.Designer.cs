...
namespace databases {
    ...
    public partial class importDS : global::System.Data.DataSet {
        ...
        public partial class importPriceDataTable : global::System.Data.TypedTableBase<importPriceRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public importPriceRow AddimportPriceRow(System.DateTime onDate, string stockCode, decimal closePrice, decimal volume, bool isTotalVolume, decimal totalVolume) {
...
SELECT onDate, stockCode, closePrice, volume, isTotalVolume FROM importPrice WHERE (onDate = @onDate) AND (stockCode = @stockCode)";
    ...
    public partial class importPriceTA : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.DeleteCommand.Connection = this.Connection;
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[importPrice] WHERE (([onDate] = @Original_onDate) AND ([stockCode] = @Original_stockCode) AND ([closePrice] = @Original_closePrice) AND ([volume] = @Original_volume) AND ([isTotalVolume] = @Original_isTotalVolume) AND ((@IsNull_totalVolume = 1 AND [totalVolume] IS NULL) OR ([totalVolume] = @Original_totalVolume)))";
            this._adapter.DeleteCommand.CommandType = global::System.Data.CommandType.Text;
            this._adapter.DeleteCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_onDate", global::System.Data.SqlDbType.DateTime, 0, global::System.Data.ParameterDirection.Input, 0, 0, "onDate", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
            this._adapter.DeleteCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_stockCode", global::System.Data.SqlDbType.NVarChar, 0, global::System.Data.ParameterDirection.Input, 0, 0, "stockCode", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
            ...
            this._adapter.InsertCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[importPrice] ([onDate], [stockCode], [closePrice], [volume], [isTotalVolume], [totalVolume]) VALUES (@onDate, @stockCode, @closePrice, @volume, @isTotalVolume, @totalVolume);
SELECT onDate, stockCode, closePrice, volume, isTotalVolume, totalVolume FROM importPrice WHERE (onDate = @onDate) AND (stockCode = @stockCode)";
            this._adapter.InsertCommand.CommandType = global::System.Data.CommandType.Text;
            this._adapter.InsertCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@onDate", global::System.Data.SqlDbType.DateTime, 0, global::System.Data.ParameterDirection.Input, 0, 0, "onDate", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._adapter.InsertCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@stockCode", global::System.Data.SqlDbType.NVarChar, 0, global::System.Data.ParameterDirection.Input, 0, 0, "stockCode", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._adapter.UpdateCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[importPrice] SET [onDate] = @onDate, [stockCode] = @stockCode, [closePrice] = @closePrice, [volume] = @volume, [isTotalVolume] = @isTotalVolume, [totalVolume] = @totalVolume WHERE (([onDate] = @Original_onDate) AND ([stockCode] = @Original_stockCode) AND ([closePrice] = @Original_closePrice) AND ([volume] = @Original_volume) AND ([isTotalVolume] = @Original_isTotalVolume) AND ((@IsNull_totalVolume = 1 AND [totalVolume] IS NULL) OR ([totalVolume] = @Original_totalVolume)));
SELECT onDate, stockCode, closePrice, volume, isTotalVolume, totalVolume FROM importPrice WHERE (onDate = @onDate) AND (stockCode = @stockCode)";
            this._adapter.UpdateCommand.CommandType = global::System.Data.CommandType.Text;
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@onDate", global::System.Data.SqlDbType.DateTime, 0, global::System.Data.ParameterDirection.Input, 0, 0, "onDate", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@stockCode", global::System.Data.SqlDbType.NVarChar, 0, global::System.Data.ParameterDirection.Input, 0, 0, "stockCode", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = "SELECT onDate, stockCode, closePrice, volume, isTotalVolume, totalVolume FROM dbo" +
                ".importPrice";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            ...
            this._commandCollection[3].CommandText = "SELECT * FROM importPrice WHERE (onDate BETWEEN @frDate AND @toDate) AND (stockCo" +
                "de = @stockCode) ORDER BY onDate DESC";
        ...
        public virtual int Delete(System.DateTime Original_onDate, string Original_stockCode, decimal Original_closePrice, decimal Original_volume, bool Original_isTotalVolume, global::System.Nullable<decimal> Original_totalVolume) {
        ...
        public virtual int Insert(System.DateTime onDate, string stockCode, decimal closePrice, decimal volume, bool isTotalVolume, global::System.Nullable<decimal> totalVolume) {
        ...
        public virtual int Update(System.DateTime onDate, string stockCode, decimal closePrice, decimal volume, bool isTotalVolume, global::System.Nullable<decimal> totalVolume, System.DateTime Original_onDate, string Original_stockCode, decimal Original_closePrice, decimal Original_volume, bool Original_isTotalVolume, global::System.Nullable<decimal> Original_totalVolume) {
            ...
            this.Adapter.UpdateCommand.Parameters[6].Value = ((System.DateTime)(Original_onDate));
            if ((Original_stockCode == null)) {
                throw new global::System.ArgumentNullException("Original_stockCode");
            }
            else {
            ...
            this.Adapter.UpdateCommand.Parameters[8].Value = ((decimal)(Original_closePrice));
            this.Adapter.UpdateCommand.Parameters[9].Value = ((decimal)(Original_volume));
            this.Adapter.UpdateCommand.Parameters[10].Value = ((bool)(Original_isTotalVolume));
            if ((Original_totalVolume.HasValue == true)) {
                this.Adapter.UpdateCommand.Parameters[11].Value = ((object)(0));
                this.Adapter.UpdateCommand.Parameters[12].Value = ((decimal)(Original_totalVolume.Value));
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(decimal closePrice, decimal volume, bool isTotalVolume, global::System.Nullable<decimal> totalVolume, System.DateTime Original_onDate, string Original_stockCode, decimal Original_closePrice, decimal Original_volume, bool Original_isTotalVolume, global::System.Nullable<decimal> Original_totalVolume) {
            return this.Update(Original_onDate, Original_stockCode, closePrice, volume, isTotalVolume, totalVolume, Original_onDate, Original_stockCode, Original_closePrice, Original_volume, Original_isTotalVolume, Original_totalVolume);
        }
    }
